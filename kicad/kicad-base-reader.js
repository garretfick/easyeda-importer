...
class KiCadBaseReader {
  ...
  static readFieldsInto (targetObject, line, fieldIdentifiers, fieldTypeConverters) {
    ...
    return KiCadBaseReader.readSplitFieldsInfo(targetObject, lineFields, fieldIdentifiers, fieldTypeConverters)
  }
   ...
   * to use as a fluent API
   */
  static readSplitFieldsInfo (targetObject, fields, fieldIdentifiers, fieldTypeConverters) {
    let maxField = Math.min(fields.length, fieldIdentifiers.length)
